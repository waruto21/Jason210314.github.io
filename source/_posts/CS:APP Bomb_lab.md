---
title: CS:APP Bomb_lab
date: 2018-12-01 17:20:21
categories:
 - CS:APP
tags:
 - CS:APP
...
## 实验步骤
### 准备工作
使用`tar -vxf`将炸弹压缩包解压,cd进入,可以从bomb.c中看出实验的用意以及程序的大致
...
炸,(％rsp)为数组首元,故r[0]＝１;跳转到+52,将r[1]地址赋给%rbx,
将r[6](实际不存在)地址赋给%rbp,跳到+27,将%eax设为%rbx指向的前一个
